...
func (mr *MockUserServiceMockRecorder) View_Users() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "View_Users", reflect.TypeOf((*MockUserService)(nil).View_Users))
}
